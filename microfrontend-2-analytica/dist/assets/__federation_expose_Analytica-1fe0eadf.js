...
let __tla = (async () => {
  ...
  }, __publicField(_a, "defaults", defaults), __publicField(_a, "instances", instances), __publicField(_a, "overrides", overrides), __publicField(_a, "registry", registry), __publicField(_a, "version", version$1), __publicField(_a, "getChart", getChart), _a);
  ...
  const { version, isProxy, toRaw, defineComponent, ref, shallowRef, onMounted, onBeforeUnmount, watch, h } = await importShared("vue");
  const CommonProps = {
    data: {
      type: Object,
      required: true
  ...
  function cloneData(data2, datasetIdKey) {
    const nextData = {
      labels: [],
      datasets: []
    };
  ...
  const Chart = defineComponent({
    ...
    setup(props, param) {
      ...
      const renderChart = () => {
        if (!canvasRef.value)
          return;
        const { type, data: data2, options: options2, plugins, datasetIdKey } = props;
        const clonedData = cloneData(data2, datasetIdKey);
        const proxiedData = cloneProxy(clonedData, data2);
  ...
  const chartConfig = Object.freeze(Object.defineProperty({
    __proto__: null,
    data,
    options
  }, Symbol.toStringTag, {
  ...
  Analytica = _export_sfc(_sfc_main, [
    [
      "render",
      _sfc_render
    ]
